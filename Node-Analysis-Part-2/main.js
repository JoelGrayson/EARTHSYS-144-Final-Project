...
// }
function exportItems(name, durations) {
    const outputString = 'Duration in Seconds,Entered At,Exited At,Place of Interest Name,Place of Interest Facility Type,Places of Interest Id\n'
        + durations
            .map(e => { var _a, _b, _c, _d; return `${e.durationInSeconds},${e.enteredAt.toISOString()},${(_a = e.exitedAt) === null || _a === void 0 ? void 0 : _a.toISOString()},${(_b = e.poi) === null || _b === void 0 ? void 0 : _b.name},${(_c = e.poi) === null || _c === void 0 ? void 0 : _c.facilityType},${(_d = e.poi) === null || _d === void 0 ? void 0 : _d.fid}`; })
            .join('\n');
    fs_1.default.writeFileSync(path_1.default.join(__dirname, 'output', name), outputString);
}
exportItems('all.csv', finalDurations);
exportItems('dining_halls.csv', finalDurations.filter(e => { var _a; return ((_a = e.poi) === null || _a === void 0 ? void 0 : _a.facilityType) === 'dining'; }));
exportItems('dorms.csv', finalDurations.filter(e => { var _a; return ((_a = e.poi) === null || _a === void 0 ? void 0 : _a.facilityType) === 'dorm'; }));
exportItems('gym.csv', finalDurations.filter(e => { var _a; return ((_a = e.poi) === null || _a === void 0 ? void 0 : _a.facilityType) === 'gym'; }));
